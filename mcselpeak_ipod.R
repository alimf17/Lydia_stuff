...
#To be heavily modified if not thrown out all together: the background prior will be the full wave generated by the priors
#subtracted from the wave of the data  
